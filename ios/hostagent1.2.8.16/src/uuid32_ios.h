 ...
 **/
void uuid_create(ios_uuid_t* uuid);
 ...
 **/
void uuid_create_external(const char *external, ios_uuid_t* uuid);

/**
 * Translate a uuid_t to a uuid string
 *  return UUID string
 **/
char *uuid_to_string(const ios_uuid_t* uuid);

/**
 * Get timestamp from a UUID
 **/
void uuid_to_timestamp(const ios_uuid_t* uuid, timestamp_t* time);
